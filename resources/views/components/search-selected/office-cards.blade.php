...
@foreach($officesWithSerials as $office => $serials)
  ...
  <div class="mb-2 flex items-center justify-between">
    <p class="font-normal text-gray-700 overflow-hidden w-32">email@email.comvxvxcvxc xvxvxv xv xcv xcv xc </p>

    <div class="flex space-x-2">
      <!-- Copy -->
      <div>
        <svg id="Copy_24" width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
          <rect width="24" height="24" stroke="none" fill="#000000" opacity="0" class="dark:fill-white-50" />
