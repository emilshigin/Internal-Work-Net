@props(['copy_id'=>'None'])
<div onclick="copyToClipboard('{{ $copy_id }}')">
<svg  id="Copy_24" width="24" height="24" viewBox="0 0 24 24" class=" hover:fill-sky-700" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
