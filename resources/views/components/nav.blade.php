...
<nav class="space-y-2">
    <a href="#" class="block py-2 px-3 rounded hover:bg-gray-200 text-gray-700">Home</a>
    <a href="#" class="block py-2 px-3 rounded hover:bg-gray-200 text-gray-700">Analytics</a>
